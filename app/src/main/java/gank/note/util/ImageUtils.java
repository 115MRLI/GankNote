...
public class ImageUtils {
     ...
     * @param <T>
     */
    public static <T extends ImageView> void showCircleImageAsPath(Context context, String path, T imageView) {
        showCircleImage(context, BASE_IMAGE_URL + path, imageView);
    }
     ...
     * @param <T>
     */
    public static <T extends ImageView> void showCircleImageAsPath(Context context, String path, T imageView, int errorResId, int placeholderResId) {
        showCircleImage(context, BASE_IMAGE_URL + path, imageView, errorResId, placeholderResId);
    }
     ...
     * @param <T>
     */
    public static <T extends ImageView> void showRoundImageAsPath(Context context, String path, T imageView, float radius) {
        showRoundImage(context, BASE_IMAGE_URL + path, imageView, radius);
    }
     ...
     * @param <T>
     */
    public static <T extends ImageView> void showRoundImageAsPath(Context context, String path, T imageView, float radius, int errorResId, int placeholderResId) {
        showRoundImage(context, BASE_IMAGE_URL + path, imageView, radius, errorResId, placeholderResId);
    }
     ...
     * @param <T>
     */
    public static <T extends ImageView> void showImageAsPath(Context context, String path, T imageView) {
        showImage(context, BASE_IMAGE_URL + path, imageView);
    }
     ...
     * @param <T>
     */
    public static <T extends ImageView> void showImageAsPath(Context context, String path,
                                                             T imageView, int errorResId, int placeholderResId) {
        showImage(context, BASE_IMAGE_URL + path, imageView, errorResId, placeholderResId);
    }
