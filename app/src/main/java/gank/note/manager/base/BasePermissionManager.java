...
public class BasePermissionManager {
     ...
     * @param listener   回调
     */
    protected static void checkSingle(Activity activity, String permission, final OnPermissionListener listener) {
     ...
     * @param listener    回调
     */
    protected static void checkMultiple(Activity activity, String[] permissions, final OnPermissionListener listener) {
        Dexter.withActivity(activity)
